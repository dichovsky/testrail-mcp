...
The verified development driver baseline is exactly `7.0.0`, release commit `71a80d984aea14713d8eeaf6ac9a0d41c1fba12b`. Its 133 operations and 48 additional helpers match the inspected main inventory at `89f636e276ea701412bb06039e3b963d83126ea1`. Its runtime does **not** include that main revision's network-guard fixes. F01 must qualify an exact published driver release containing those fixes, the report-execution change and the operation-settlement API below. F03 depends on F01 and adopts the qualified version in the package/lockfile before its runtime guarantees can pass; scaffolding and independent fixture preparation can use 7.0.0 meanwhile. Update provenance and regression evidence with the dependency; do not guess a future version number.
