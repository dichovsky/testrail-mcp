...
// One entry per family, spread in order. T09–T12 add theirs alongside; keeping a
// file per family means parallel work edits disjoint files rather than this one.
export const operationRegistry = createRegistry(...t01, ...t02, ...t03, ...t04, ...t05, ...t06, ...t07, ...t08);
