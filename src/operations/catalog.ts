...
import { t12 } from './families/t12.js';
import { createRegistry } from './registry.js';

// One entry per family, spread in order. Keeping a file per family means parallel
// work edits disjoint files rather than this one.
